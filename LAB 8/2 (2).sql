...
values ('John', 'Snow' ,'13.09.2001');
insert into Student (First_Name, Last_Name, Date_of_birth)
values ('Lili', 'Rose','14.09.2001' );
insert into Student (First_Name, Last_Name, Date_of_birth)
values ('Michael', 'Will','16.09.2001');
...
as $$
    begin
        if valid (new.password ) = true then
            update profile
            set val = true, last = outputs(new.last)
...
insert into profile (username, last, password)
values ('Ali', 'Yelemessov', 'Alinur123');
